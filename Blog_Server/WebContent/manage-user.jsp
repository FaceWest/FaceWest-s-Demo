...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        ...
        <input name="op" value="query" type="hidden">
        用户名：<input name ="accout" value="${param.accout}">
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">姓名:</td>
                <td width="80%"><input type="text" value="" class="form-control" id="${param.name}" name="truename" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="" class="form-control" id="${param.account}" name="username" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">电话:</td>
                <td width="80%"><input type="text" value="" class="form-control" id="${param.tel}" name="usertel" maxlength="13" autocomplete="off" /></td>
              </tr>
              <tr>
               <!--  <td wdith="20%">旧密码:</td>
